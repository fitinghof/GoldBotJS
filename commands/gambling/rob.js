...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('rob')
		.setDescription(`Rob another player, make sure they're not home!, costs 1/5 of however much you try to take in equipment`)
        ...
        .addIntegerOption(option =>
            ...
            .setDescription("How much will you try to take?")
            .setMinValue(100)),
	    async execute(interaction) {
            ...
            if (!targetUserGame) return await interaction.reply({content: `You find your supposed target lying begging for cash outside of ICA. You kick him and leave.`, ephemeral: true}) 
            ...
            return await interaction.reply({content: `After tripping on a sausage and slapping the dog with a lamp you get caught by the police and lose you pricey equipment!`, ephemeral: true})
        }
}